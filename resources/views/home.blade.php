    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <article class="flex flex-col shadow my-4">
            ...
            <a href="#" class="hover:opacity-75">
                <img src="https://th.bing.com/th/id/OIP.pHJndtItCRYlzU9JjBgdEAHaFO?rs=1&pid=ImgDetMain">
            </a>
        ...
        <article class="flex flex-col shadow my-4">
            <!-- Article Image -->
            <a href="#" class="hover:opacity-75">
                <img src="https://www.sopapeldeparede.com.br/wp-content/uploads/2015/03/Papel-de-parede-Natureza-Por-do-sol-1-1024x576.jpg">
            </a>
            <div class="bg-white flex flex-col justify-start p-6">
