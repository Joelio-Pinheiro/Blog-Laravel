...
<body class="bg-gray-50 font-family-karla">
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            ...
            <p class="text-lg text-gray-600">
                {{ \App\Models\TextWidget::getTitle('head') }}
            </p>
        </div>
    </header>
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        <div class="block sm:hidden">
            <a href="#" class="block md:hidden text-base font-bold uppercase text-center " @click="open = !open">
                    ...
                    @auth
                        ...
                        <div class="flex sm:items-center sm:ms-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="flex items-center hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2">
